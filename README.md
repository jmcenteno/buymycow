...
- With JavaScript enabled and running the app in development mode (`npm start`), you can test the CSS hot reloading by changing this file /src/client/index.css
...
- common. This is code that runs both on the server and on the client
